...
export abstract class ClientEvmApi extends ApiModule {
  ...
  public readonly nft = {
   ...
   getNFTTradesByToken: (request: GetNFTTradesByTokenOperationRequest): Promise<PaginatedResponseV3Adapter<GetNFTTradesByTokenOperationResponse, GetNFTTradesByTokenOperationResponseJSON>> => {
      return new PaginatedOperationV3Resolver(GetNFTTradesByTokenOperation, this.baseUrl, this.core).fetch(request, null);
    },
  ...
  public readonly token = {
   ...
   getTopProfitableWalletPerToken: (request: GetTopProfitableWalletPerTokenOperationRequest): Promise<ResponseAdapter<GetTopProfitableWalletPerTokenOperationResponse, GetTopProfitableWalletPerTokenOperationResponseJSON>> => {
      return new OperationV3Resolver(GetTopProfitableWalletPerTokenOperation, this.baseUrl, this.core).fetch(request, null);
    },
  ...
  public readonly wallets = {
   getWalletApprovals: (request: GetWalletApprovalsOperationRequest): Promise<PaginatedResponseV3Adapter<GetWalletApprovalsOperationResponse, GetWalletApprovalsOperationResponseJSON>> => {
      return new PaginatedOperationV3Resolver(GetWalletApprovalsOperation, this.baseUrl, this.core).fetch(request, null);
    },
   ...
   getWalletProfitabilitySummary: (request: GetWalletProfitabilitySummaryOperationRequest): Promise<ResponseAdapter<GetWalletProfitabilitySummaryOperationResponse, GetWalletProfitabilitySummaryOperationResponseJSON>> => {
      return new OperationV3Resolver(GetWalletProfitabilitySummaryOperation, this.baseUrl, this.core).fetch(request, null);
    },
   getWalletProfitability: (request: GetWalletProfitabilityOperationRequest): Promise<ResponseAdapter<GetWalletProfitabilityOperationResponse, GetWalletProfitabilityOperationResponseJSON>> => {
      return new OperationV3Resolver(GetWalletProfitabilityOperation, this.baseUrl, this.core).fetch(request, null);
    },
